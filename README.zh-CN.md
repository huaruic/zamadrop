...
合约通过 `FHE.checkSignatures` 在改写状态前校验 KMS threshold 签名,因此 caller 身份对完整性无关——信任根是 KMS 签名而不是谁在提交。架构理由见 [ADR 0003](./docs/ADR/0003-frontend-as-primary-executor.md),完整信任分析见 [Security Model](#security-model)。
